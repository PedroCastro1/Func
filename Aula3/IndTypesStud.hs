...
-}
type Address = [(Person, String,String)]

addr01 = (Mary, "Avenida Goethe, 522", "97285522")
addr02 = (John, "Nilo Peçanha, 1024-201", "90267012")

{-
  Exercício:
  Escrever funções para as operações usuais de consulta, remoção e
  atualização sobre o tipo Address.
-}
